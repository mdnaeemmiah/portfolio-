...
const Register = () => {
  ...
  return (
    <section className="max-w-7xl mx-2 w-full flex items-center justify-center bg-white rounded-lg">
      <div className="p-5 md:w-1/2 xl:px-16 flex flex-col">
        <h3 className="text-2xl font-bold leading-10 tracking-wide mt-5">Register</h3>
        <p className="text-xl my-5">Join us and start your journey today!</p>
        ...
        >
          ...
          {/* Email */}
          <label htmlFor="email" className="font-medium flex gap-1">
            Email <span className="text-pink-700">*</span>
          </label>
          <Controller
            name="email"
          ...
          {/* Password */}
          <label htmlFor="password" className="font-medium flex gap-1">
            Password <span className="text-pink-700">*</span>
          </label>
          <Controller
            name="password"
          ...
          <Button
            ...
            color="primary"
            disabled={isLoading}
            className="text-lg py-5 mt-4 hover:scale-105 transition duration-300"
          >
            {isLoading ? "Registering..." : "Register"}
          </Button>
        </form>
