...
export default function ContactUsPage() {
    return (
      <section className="min-h-screen bg-slate-50 px-5 max-w-6xl mx-auto pt-9 mt-20">
        {/* <div className="">    
          <h1 className="text-5xl text-[rgb(60,0,64)] mt-16 font-bold my-5">
            Everything for pets & pet parents in one place.
          </h1>  
        
          <p className="text-xl text-[rgb(60,0,64) my-5 ">
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-wrap -mx-6">
              <div className="w-full md:w-1/2 px-6 mb-6 md:mb-0 flex flex-col justify-center ">
                ...
                <p className="mb-4 text-xl text-[rgb(60,0,64) my-5 mb-8">
              ...
              <div className="w-full md:w-1/2 px-6">
                ...
                <form className="">
                  ...
                  <button   type="submit" className="bg-[#EF1F76] text-white py-2 px-4 rounded-md font-semibold hover:bg-[#C51963] hover:scale-105 transform transition duration-300">
                    send massage
                  </button>
