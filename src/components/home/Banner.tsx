      ...
      <div className="flex-1 text-center md:text-left">
        ...
        <div className="mt-5 flex gap-4 justify-center md:justify-start">
          ...
          {/* <Link href="/resume">
           ...
           {/* Preview Resume */}
            <Link
              href="https://drive.google.com/file/d/1F-bAgsY_3VPgRs68RKaNbLIIH2zt6CT2/view?usp=sharing"
              target="_blank"
            ...
            {/* Download Resume */}
            <a
              href="https://drive.google.com/uc?export=download&id=1F-bAgsY_3VPgRs68RKaNbLIIH2zt6CT2"
              download
